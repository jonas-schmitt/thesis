...
In general, a stencil code can be considered a set of mappings from an n-dimensional index vector to a complex-valued number.
...
\end{equation}
which corresponds precisely to the left part of Equation~\ref{eq:2D-poisson-model-discrete}.
