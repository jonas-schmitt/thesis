...
As we now have all the components together, we can finally specify the complete grammar for constructing multigrid methods on a given hierarchy of discretizations.
...
\begin{algorithm}
	...
	\end{bnf*}
\end{algorithm}
Algorithm~\ref{alg:multigrid-grammar} shows the resulting productions of the grammar.
...
%TODO discuss how grammar can be adapted to other discretization hierarchies
