...
\end{listing}
The \emph{entries} attribute of this class directly corresponds to the set $S$ defined in Equation~\ref{eq:stencil-definition}, whereby we use a \emph{tuple} object to represent this mathematical entity in the Python programming language.
Each entry $e_i$ of this object, thus, represents a tuple of the form of
\begin{equation}
...
For instance, the finite-difference discretization of the Laplace operator $\Delta$ on a two-dimensional uniform grid leads to the stencil 
\begin{equation*}
	\begin{split}
