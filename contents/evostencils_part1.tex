...
\end{listing}
The \emph{entries} attribute of this class directly corresponds to the set $S$ defined in Equation~\ref{eq:stencil-definition}, whereby we use a \emph{tuple} object to represent this set in the Python programming language.
