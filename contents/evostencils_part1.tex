...
In DEAP the main data structure to represent a typed GP system is a \emph{PrimitiveSetTyped}, which defines the rules how a program can be constructed based on a set of terminals and so-called \emph{primitives}.
