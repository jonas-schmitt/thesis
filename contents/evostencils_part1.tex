...
For this purpose, we first need to generate the set of terminals that is defined on each level of the hierarchy, which is encapsulated into the class \texttt{Terminals} shown in~\ref{code:grammar:terminals.py}.
\begin{listing}
