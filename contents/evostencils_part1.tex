...
Using this framework, we will show how it is possible to discover structurally-novel methods that are able to solve certain PDE-based problems faster than all classical multigrid cycles.
...
As a first step, we will outline the implementation of an intermediate representation for multigrid methods that can be easily generated based on a given derivation tree and which then acts as a basis for all subsequent steps of solver generation and evaluation.
