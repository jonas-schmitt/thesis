...
For each of the \emph{Primitive} objects generated in line~9--17 whose list of input types contains only unguarded types, the output type is also unguarded.
