...
We then include the initial state as a tuple consisting of the respective \emph{Approximation} and \emph{RightHandSide} object and all level-independent terminals in line~14--21.
