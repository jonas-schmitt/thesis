...
Before we can formulate a major theorem about the convergence of this sequence, we first have to introduce the spectral radius 
\begin{equation}
...
\begin{theorem}
$\lim_{k \to  \infty} G^k = 0$ if and only if $\rho(G) < 1$.
\end{theorem}
%TODO prove theorem
