...
\begin{figure}
 ...
 \centering
  ...
  \centering
	...
	\end{subfigure}
 \caption{Expression trees of the functions $f_1$ and $f_2$~\eqref{eq:gp-example-functions}, where we have simplified the if-then-else construct to a single ternary operator.}
