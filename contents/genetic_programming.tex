...
In tree-based G3P, each individual is represented by a grammar derivation tree.
Therefore, to generate an individual from scratch, starting with $S$ as a root node, we can successive extend a tree by choosing a production for each variable present in the tree until all leaves consist exclusively of terminal symbols.
