...
Again, as an example, the derivation trees for $f_1$ and $f_2$ are shown in Figure~\ref{fig:gp-derivation-tree-example-1} and~\ref{fig:gp-derivation-tree-example-2}, respectively.
\begin{figure}
\includegraphics{figures/gp_derivation_tree1.pdf}
\caption{Derivation tree for $f_1$.}
\label{fig:gp-derivation-tree-example-1}
\end{figure}
\begin{figure}
	\includegraphics{figures/gp_derivation_tree2.pdf}
	\caption{Derivation tree for $f_2$.}
	\label{fig:gp-derivation-tree-example-2}
\end{figure}
