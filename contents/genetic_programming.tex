...
While strongly-typed GP represents a viable solution to the problem of retaining type correctness, it requires us to transform the implicit type information contained within the productions of our grammar into explicit type annotations at the nodes of each expression tree.
%TODO grammar-based GP