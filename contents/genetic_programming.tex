...
\subsection{Initialization, Mutation and Crossover}
...
Consider for instance the following tree generated by the example grammar formulated in Equation~\eqref{eq:gp-example-grammar}.
\begin{figure}
	\centering
