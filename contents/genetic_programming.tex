...
After a single or multi-objective fitness value has been assigned to each individual, obtained either through random initialization or mutation and recombination of existing individual, the questions remains how the search should be progressed by selecting a novel population for the next generation from the set of available individuals.
...
Another recently proposed selection operator that is especially geared towards problems where the fitness evaluation is performed on multiple test cases, is lexicase selection.
...
\begin{figure}
	\centering
	\includegraphics[scale=0.4]{figures/trees/subtree_insertion_mutation.pdf}
