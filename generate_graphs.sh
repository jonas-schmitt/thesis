...
dot2tex -c -f tikz --prog dot --preproc gp_grow_tree.dot > tmp.dot
dot2tex -c -f tikz --prog dot -tmath tmp.dot > gp_grow_tree.tex
pdflatex gp_grow_tree.tex
dot2tex -c -f tikz --prog dot --preproc gp_grow_tree1.dot > tmp.dot
dot2tex -c -f tikz --prog dot -tmath tmp.dot > gp_grow_tree1.tex
pdflatex gp_grow_tree1.tex
dot2tex -c -f tikz --prog dot --preproc gp_grow_tree2.dot > tmp.dot
