...
\chapter{The EvoStencils Framework: Core Implementation}
  \input{contents/evostencils_part1.tex}
\chapter{The EvoStencils Framework: Parallelization and Extensions}
  \input{contents/evostencils_part2.tex}
  % TODO currently dummy file \input{contents/solver_evaluation.tex}
